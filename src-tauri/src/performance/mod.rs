...
mod tests {
    ...
    #[test]
    fn test_resource_state_abundant() {
        assert_eq!(
    ...
    #[test]
    fn test_resource_state_moderate() {
        assert_eq!(
    ...
    #[test]
    fn test_resource_state_constrained() {
        assert_eq!(
    ...
    #[test]
    fn test_resource_state_critical() {
        assert_eq!(
    ...
    fn test_reset() {
        ...
        m.update_memory(512);
        m.reset();
        assert_eq!(m.current_memory_mb(), 512); // current_memory not reset
        assert_eq!(m.avg_inference_time_ms(), 0.0);
    }
